                    ...
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <div class="page-title">
                                <h4 class="mb-0 font-size-18">Modelos</h4>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="table-responsive order-table">
                                        <table class="table table-hover align-middle mb-0" >
                                            ...
                                            <tr>
                                                ...
                                                <th scope="row" id="titulo"><?php echo $m->modelo?></th>

                                                <td class="text-right">
                                                    <div>
                                                        <a  class="btn btn-primary btn-sm editar-model" data-id="<?php echo $m->id?>" data-title="<?php echo $m->modelo?>" data-bs-toggle="modal" data-bs-target="#editar">Editar</a>
                                                        <a  class="btn btn-danger btn-sm delele-model"  data-id="<?php echo $m->id?>" >Excluir</a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <?php }?>
...
<?php echo $__env->make('adm.modulos.modelos.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('adm.modulos.modelos.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</html><?php /**PATH /home/phmultimarcas/dash.phmultimarcas.com.br/resources/views/adm/modulos/modelos/index.blade.php ENDPATH**/ ?>
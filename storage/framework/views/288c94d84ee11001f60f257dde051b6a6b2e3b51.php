    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel">Editar Câmbio</h5>
            ...
            <form method="post" class="needs-validation" id="editar" enctype="multipart/form-data" novalidate>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label" for="edt_cambio">Tipo de câmbio</label>
                                <input type="text" class="form-control" id="edt_cambio" name="edt_cambio" placeholder="" required>
...
</div><?php /**PATH /home/phmultimarcas/dash.phmultimarcas.com.br/resources/views/adm/modulos/cambio/edit.blade.php ENDPATH**/ ?>
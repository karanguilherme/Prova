                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="opcional">Nome do Opcional</label>
                                <input type="text" class="form-control" id="opcional" name="opcional" placeholder="Ex: Vidro Eletrico, Direção Hidráulica" value="" required>
                            </div>
...
<?php /**PATH /home/phmultimarcas/dash.phmultimarcas.com.br/resources/views/adm/modulos/opcionais/create.blade.php ENDPATH**/ ?>
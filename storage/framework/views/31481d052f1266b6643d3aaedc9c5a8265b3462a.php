                                ...
                                <div class="card-body">
                                    <div class="table-responsive order-table">
                                        <table class="table table-hover align-middle mb-0" >
                                            ...
                                            <tr>
                                                <td id="nome">
                                                    <?php echo $p->nome_pagina?>
                                                </td>
                                                <td class="text-right">
                                                    <div>
                                                        <a  class="btn btn-primary btn-sm editar-model" data-id="<?php echo $p->id_pagina?>" data-title="<?php echo $p->nome_pagina?>" data-bs-toggle="modal" data-bs-target="#editar">Editar</a>
                                                        <a  class="btn btn-danger btn-sm delele-model"  data-id="<?php echo $p->id_pagina?>" >Excluir</a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <?php }?>
...
<?php echo $__env->make('adm.modulos.paginas.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('adm.modulos.paginas.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</html><?php /**PATH /home/phmultimarcas/dash.phmultimarcas.com.br/resources/views/adm/modulos/paginas/index.blade.php ENDPATH**/ ?>
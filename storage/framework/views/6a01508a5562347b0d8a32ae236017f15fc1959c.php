    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel">Nova Cor</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="cor" name="cor" placeholder="Ex: Azul, preto, prata" value="" required>
                            </div>
...
<?php /**PATH /home/phmultimarcas/dash.phmultimarcas.com.br/resources/views/adm/modulos/cores/create.blade.php ENDPATH**/ ?>
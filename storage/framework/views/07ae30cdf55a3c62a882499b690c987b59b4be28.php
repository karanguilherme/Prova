    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel">Novo Banner</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="campanha" name="campanha" placeholder="Nome da campanha" value="" required>
                            </div>
                            <div class="mb-3">
...
</div><?php /**PATH /home/phmultimarcas/dash.phmultimarcas.com.br/resources/views/adm/modulos/marketing/create.blade.php ENDPATH**/ ?>